...
verify/serialize/pretty_print interfaces, and this contract. Shape-inference
hooks (`inference.py`, 23 hooks) are implemented; the remaining behavioral
bodies (Builder, verify, serialize, pretty_print) are `NotImplementedError`
stubs — Phase 2 (implementation, delegated to a Manager) fills them.