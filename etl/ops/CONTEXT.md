...
| File | Area |
|---|---|
| `__init__.py` | Re-exports the 85 public names (`__all__`); import-time `_registration.register_operator_handlers()` |
...
| `linalg.py` | `dot conv tril triu cumsum solve sort diagonal trace norm eigh cholesky qr matrix_rank svd matrix_exp` |
