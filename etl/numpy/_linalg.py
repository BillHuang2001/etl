...
`etl.numpy.linalg` submodule. Architecture phase: stubs raise
NotImplementedError.
"""
...
def matmul(a, b):
    ...
    raise NotImplementedError("enp.matmul: architecture stub — maps to ops.dot")
...
def dot(a, b):
    ...
    """
    raise NotImplementedError("enp.dot: architecture stub — maps to ops.dot")


def solve(a, b):
    """numpy.linalg.solve → ops.solve(a, b).

    NOTE: ops.solve is not yet in the etl/ops public contract (see CONTEXT.md
    conflicts) — stays NotImplementedError until ops publishes it.
    """
    raise NotImplementedError(
        "enp.linalg.solve: architecture stub — maps to ops.solve"
    )
